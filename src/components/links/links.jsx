...
function Links(props) {
  ...
  return (
      <div className={`links ${style}`}>
        ...
        <a className='links__link' href="https://github.com/zagyrkti" rel='noreferrer noopener'
           target='_blank'>Github</a>
        <a className='links__link' href="https://www.facebook.com/" rel='noreferrer noopener'
