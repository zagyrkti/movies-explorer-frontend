        ...
        <div className='techs__content'>
          <div className='techs__text'>
            <div>
              ...
              <p className='techs__promo-secondary techs__promo-secondary_type_main'>- за 10 месяцев курса
                веб-разработки от Яндекс.Практикум</p>
            ...
            <div>
              ...
              <p className='techs__promo-secondary techs__promo-secondary_type_main'>- за время курса сделано 15
                проектных работ</p>
            ...
            <div>
              ...
              <p className='techs__promo-secondary techs__promo-secondary_type_mobile'>Для построения данного
                проекта</p>
            </div>
          </div>
