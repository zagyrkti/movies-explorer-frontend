  ...
  return (
    <div className='person-data'>
      ...
      <div className='person-data__info'>
        ...
        <p className='person-data__about'>Я родился и живу в Саратове, закончил факультет экономики СГУ. У меня есть жена и дочь. Я люблю слушать
        ...
        <LinkButton className='person-data__link-button' priority='high' link='https://github.com/zagyrkti'>GitHub</LinkButton>
      </div>
    </div>
  )
}
